...
Luego le diremos a Java que cualquier objeto `MessagePost` es un `Post` y que cualquier objeto `MessagePost` también es un `Post`. Finalmente añadiremos aquellos detalles adicionales propios de `MessagePost` en esa clase y aquellos detalles adicionales propios de `PhotoPost` en esa otra clase.
