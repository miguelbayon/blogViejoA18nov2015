...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0035">
Mostrar solucion
</button></div>
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0043_1">
Mostrar pista
</button></div>
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0046">
Mostrar solucion
</button></div>
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0052">
Mostrar solucion
</button></div>
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0057">
Mostrar solucion
</button></div>
...
<!--<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0061">
Mostrar solucion
</button></div>
<div id="0061" class="collapse" markdown="1">
...
<!--<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0062">
Mostrar solucion
</button></div>
<div id="0062" class="collapse" markdown="1">
[Ver vídeo en Youtube]()
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0066">
Mostrar solucion
</button></div>
<div id="0066" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0067">
Mostrar solucion
</button></div>
<div id="0067" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0068_pista1">
Mostrar pista
</button></div>
<div id="0068_pista1" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0068">
Mostrar solucion
</button></div>
<div id="0068" class="collapse" markdown="1">
Un solución al apartado 1 sería:
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0069">
Mostrar solucion
</button></div>
<div id="0069" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0070">
Mostrar solucion
</button></div>
<div id="0070" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0072">
Mostrar solucion
</button></div>
<div id="0072" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0081">
Mostrar solucion
</button></div>
<div id="0081" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0082">
Mostrar solucion
</button></div>
<div id="0082" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0083_1">
Mostrar pista 1
</button></div>
<div id="0083_1" class="collapse" markdown="1">
Investiga en la documentación de la clase `String` si hay algún método que nos pueda ayudar a completar el ejercicio.
</div>

<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0083_2">
Mostrar pista 2
</button></div>
<div id="0083_2" class="collapse" markdown="1">
Investiga los métodos `trim` y `toLowerCase` de la clase `String`.
</div> 

<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0083">
Mostrar solucion
</button></div>
<div id="0083" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0084">
Mostrar solucion
</button></div>
<div id="0084" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0085">
Mostrar solucion
</button></div>
<div id="0085" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0086">
Mostrar solucion
</button></div>
<div id="0086" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0087">
Mostrar solucion
</button></div>
<div id="0087" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0088">
Mostrar solucion
</button></div>
<div id="0088" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0089">
Mostrar solucion
</button></div>
<div id="0089" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0090">
Mostrar solucion
</button></div>
<div id="0090" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0091">
Mostrar solucion
</button></div>
<div id="0091" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0092">
Mostrar solucion
</button></div>
<div id="0092" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0093">
Mostrar solucion
</button></div>
<div id="0093" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0094">
Mostrar solucion
</button></div>
<div id="0094" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0095">
Mostrar solucion
</button></div>
<div id="0095" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0096">
Mostrar solucion
</button></div>
<div id="0096" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0099">
Mostrar solucion
</button></div>
<div id="0099" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0100">
Mostrar solucion
</button></div>
<div id="0100" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0107">
Mostrar solucion
</button></div>
<div id="0107" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0108">
Mostrar solucion
</button></div>
<div id="0108" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0109">
Mostrar solucion
</button></div>
<div id="0109" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0110">
Mostrar solucion
</button></div>
<div id="0110" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0111">
Mostrar solucion
</button></div>
<div id="0111" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0112">
Mostrar solucion
</button></div>
<div id="0112" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0113_1">
Mostrar pista 1
</button></div>
<div id="0113_1" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0113_2">
Mostrar pista 2
</button></div>
<div id="0113_2" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0113">
Mostrar solucion
</button></div>
<div id="0113" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0114">
Mostrar solucion
</button></div>
<div id="0114" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0115">
Mostrar solucion
</button></div>
<div id="0115" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0116">
Mostrar solucion
</button></div>
<div id="0116" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0117">
Mostrar solucion
</button></div>
<div id="0117" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0118">
Mostrar solucion
</button></div>
<div id="0118" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0119">
Mostrar solucion
</button></div>
<div id="0119" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0122">
Mostrar pista 
</button></div>
<div id="0122" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0124_1">
Mostrar pista 1
</button></div>
<div id="0124_1" class="collapse" markdown="1">
...
<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0124_2">
Mostrar pista 2
</button></div>
<div id="0124_2" class="collapse" markdown="1">
...
<table id="uml">	
	<tr>
		<td id="nombreClase">EntradaTexto</td>
	</tr>
	<tr>
		<td>
		-username: String<br>
	...
	<tr>
		<td>
		+EntradaTexto(String author, String text)<br>
		+like()<br>
		+unlike()<br>
		+addComment(String text)<br>
		+getText(): String<br>
		+getTimeStamp(): long<br>
		+display()<br>
...
<table id="uml">	
	<tr>
		<td id="nombreClase">EntradaFoto</td>
	</tr>
	<tr>
		<td>
		-username: String<br>
	...
	<tr>
		<td>
		+EntradaFoto(String author, String filename, String caption)<br>
		+like()<br>
		+unlike()<br>
		+addComment(String text)<br>
...
<table id="uml">	
	...
	<tr>
		<td>
		-messages: EntradaTexto[]<br>
		-photos: EntradaFoto[]<br>
		</td>
	</tr>
	<tr>
		<td>
		+NewsFeed()<br>
		+addEntradaTexto(EntradaTexto message)<br>
		+addEntradaFoto(EntradaFoto photo)<br>		
		+show()<br>
		</td>
	</tr>
</table>
...
<div markdown="0"><button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#0127">
Mostrar solucion
</button></div>
<div id="0127" class="collapse" markdown="1">

__Punto 6__

Existen varios problemas de diseño con la solución actual. El más evidente es la duplicación de código.

Las clases `EntradaTexto` y `EntradaFoto`` son muy similares. De hecho, la mayoría del código es idéntico. Ya conocemos los problemas que supone la repetición de código. Aparte de la pesadez que supone escribir lo mismo dos veces (o copiar y pegar y modificar luego las pequeñas diferencias existentes entre ambas clases) hay otros problemas asociados con la repeticion de código.

Así, si tenemos que hacer un cambio en las partes de código duplicadas, deberemos hacerlo dos veces. Por ejemplo, si introdujeramos una clase `Comment` para los comentarios, el atributo `comments` pasaría de ser un `ArrayList` de `String` a ser un `ArrayList` de objeto `Comment` y este cambio habría que realizarlo en `EntradaTexto` y en `EntradaFoto`. Si este cambio lo realiza posteriormente un programador diferente al que escribió el código original es posible que no se de cuenta de que hay que hacerlo en ambas clases.

También en la clase `NewsFeed` muchas tareas hay que repetirlas dos veces, una para los post de texto y otra para los post de imagen. Se definen dos atributos, se inicializan los dos atributos, se definen dos métodos `add` y se codifican dos bloques de código prácticamente idénticos en el método `show` para mostrar ambas colecciones.

El problema con la clase `NewsFeed` es muy evidente si pensamos en la posibilidad de añadir un nuevo tipo de post a nuestra red social. Imagina que queremos tener no solo post de texto o de imagen si no que aparezcan también post de enlaces. Estos post contendrían una URL. La implementación de estos post debería ser sencilla en nuestra aplicación dado que son bastante similares a los post que ya tenemos funcionando. Deberíamos introducir otra clase denominada `LinkEntrada` y básicamente escribir una tercera versión del código fuente de las clases `EntradaTexto` o `EntradaFoto` y, posteriormente, añadir en la clase `NewsFeed` otra colección como atributo para almacenar estos post, otro método `add` para poder añadirlos a dicho colección y otro bucle en el método `show`.

Lo peor es que por cada tipo nuevo de post tendríamos que repetir la misma tarea. Esto es evidentemente una situación no deseable y, cuando tenemos una situación no deseable en una aplicación, lo más probable es que exista otra solución con un diseño más correcto. En este caso particular la solución la tenemos en la aplicación de la herencia
...
La herencia es el mecanismo que permite derivar una o varias clases, denominadas subclases, de otra más genérica llamada superclase.

En nuestro caso, en vez de definir dos clases completamente independientes `EntradaTexto` y `EntradaFoto` lo primero que hacemos es definir una clase que contiene todo aquello que estas dos clases tienen en común. Llamaremos a esta clase `Entrada`. 

Luego le diremos a Java que cualquier objeto `EntradaTexto` es un `Entrada` y que cualquier objeto `EntradaFoto` también es un `Entrada`. Finalmente añadiremos aquellos detalles adicionales propios de `EntradaTexto` en esa clase y aquellos detalles adicionales propios de `EntradaFoto` en esa otra clase.

La herencia nos permite por tanto escribir todo aquello que ambas clases tienen en común solo una vez.

A continuación se muestra el diagrama UML de la nueva estructura. Encima de todo se muestra la clase `Entrada`, que define todos los atributos y métodos comunes a todos los tipos de post. Debajo se muestran las clases `MesssageEntrada` y `EntradaFoto` conteniendo aquellos atributos y métodos propios únicamente de dichas clases.

<img src="/images/Captura01.png" class="img-responsive">

La herencia, presente en todos los lenguajes de programación orientados a objetos, define una serie de conceptos. En nuestro ejemplo, decimos que la clase `EntradaTexto` _hereda_ de la clase `Entrada`; también decimos que la clase `EntradaFoto` _hereda_ de la clase de `Entrada`. Las flechas representadas en el diagrama representan las relaciones de herencia.

La clase `Entrada` es denominada la _clase padre_ o la _superclase_ mientras que las clases que heredan, `EntradaTexto` y `EntradaFoto` se denominan _clases hijas_ o _subclases_.

Es importante darse cuenta que las subclases son una especialización de la superclase. Podemos decir que un objeto de tipo `EntradaTexto` _es un_ objeto de tipo `Entrada` y que un `EntradaFoto` _es un_ `Entrada` igualmente.

Uno de los propósitos de la herencia se muestra claramente en el ejemplo. Los objetos de tipo `EntradaTexto` tienen todos los atributos definidos en su clase y, además, los atributos definidos en su superclase, es decir, los definidos en la clase `Entrada`. Así, los atributos `username`, `timestamp`, `likes` y `comments` de definen y se inicializan solo una vez pero podemos usarlos en dos clases: `EntradaTexto` y `EntradaFoto`.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    c 
Esto mismo también es aplicable a los métodos. Los objetos de las subclases disponen de todos los métodos definidos en la superclase. En general podemos resumir en que dado que un post de texto es un post el primero contendrá todo lo propio de los post y además todos lo propio de un post de texto.

La herencia nos permite crear dos clases muy similares sin tener que escribir las partes comunes a ambas. 



### Jerarquías de herencia

La herencia es posible usarla en situaciones más complejas que la representada por nuestro ejemplo. Más de dos clases pueden heredar de la misma superclase y una subclase pueder ser, a su vez, superclase para otras subclases. 

En esta situación tenemos lo que denominamos una _jerarquía de herencia_. 

El mejor ejemplo de una jerarquía de herencia es, probablemente, la clasificación de las especies usada por los biólogos. Esta jerarquía se puede observar en la siguiente imagen:

<img src="/images/Captura02.png" class="img-responsive">

En el diagrama podemos ver que un caniche (_poodle_) es un perro, el cual es un mamífero y a su vez es un animal.

Sabemos ciertas cosas sobre los caniches (por ejemplo, que estan vivos, que pueden ladrar, que comen carne, que dan a luz a crías, etc.). Si nos fijamos más nos damos cuenta que muchas de estas cosas las sabemos no porque sean caniches si no porque son perros, o porque son mamíferos o porque son animales. 

Si pensamos en un objeto de la clase `Poodle` tiene las características propias de un caniche, un perro, un mamífero y un animal porque es un caniche, un perro, un mamífero y un animal.

La idea es que la herencia es una técnica de abstracción que nos permite categorizar clases de objetos bajo un determinado criterio y que nos ayuda a especificar las características de estas clases.



### Actividad 0128

1. Dibuja el diagrama de herencia de un conjunto de clases a tu elección.



### Herencia en Java

La herencia en Java se implementa simplemente especiﬁcando la palabra reservada `extends` en la deﬁnición de la subclase:

{% highlight java %}
class nombreSubclase extends nombreSuperclase 
{
    // Atributos y metodos especificos de la subclase
}
{% endhighlight %}
...
class Planeta extends Esfera 
{
    ...
    public void setNumSatelites(int ns) {    
        numSatelites = ns; 
    }
}
{% endhighlight %}

En este ejemplo la clase `Planeta` hereda todos los métodos y atributos deﬁnidos en `Esfera`. Al ﬁn y al cabo, un planeta también es una esfera (despreciaremos las pequeñas deformaciones que pueda tener). En el siguiente fragmento de código vemos cómo es posible acceder a los atributos y métodos heredados:

{% highlight java %}
Planeta tierra = new Planeta();
tierra.setRadio(6378);
tierra.setNumSatelites(1);
System.out.println("Superficie = " + tierra.superficie());
{% endhighlight %}

En el ejemplo anterior puede observarse cómo los objetos de la clase `Planeta` utilizan los métodos heredados de `Esfera` (`setRadio` y `superficie`) exactamente del mismo modo a como utiliza los deﬁnidos en su misma clase (`setNumSatelites`).

Cuando se deﬁne un esquema de herencia, la subclase hereda todos los miembros (métodos y atributos) de la superclase. Debe observarse que en el ejemplo anterior la clase `Planeta` hereda el atributo `radio`. Sin embargo, el problema es que desde la subclase no podemos acceder al atributo `radio` dado que es privado y, por tanto, solo accesible desde la clase que lo define (`Esfera`). Esto no quiere decir que los planetas no tengan un radio asociado, sino que no es posible acceder directamente a ese atributo. Los objetos de tipo `Planeta` solo pueden establecer su radio a través del método `setRadio`. 

Ese es uno de los motivos por el cual es una práctica muy habitual deﬁnir como privados los atributos de una clase e incluir métodos públicos que den acceso a dichos atributos. 

Veamos un nuevo ejemplo sobre el uso de la herencia. Supongamos que queremos implementar un juego en el que una nave debe disparar a ciertas amenazas que se le aproximan. De forma muy simplista, podríamos deﬁnir el comportamiento de nuestra nave mediante el siguiente código:

{% highlight java %}
class Nave 
{

    private int posX, posY; // Posicion de la nave en la pantalla 
    ...
    void disparar() {
        if (municion > 0) {
            municion--;
        // Aqui iría el codigo necesario para realizar disparo 
        }
    }

    void dibujar() {
        // Obviaremos la parte grafica y nos limitaremos a mostrar 
        // un texto por la consola
        System.out.println("Nave en " + posX + "," + posY);
        System.out.println("Municion restante: " + municion);
    }
}
{% endhighlight %}
...
El aspecto interesante del ejemplo anterior es observar que la subclase `NaveConEscudo` incluye todos los elementos de la clase `Nave` tal y como si hubiesen sido deﬁnidos en la propia clase `NaveConEscudo`. 

Esta característica permite deﬁnir con un mínimo esfuerzo nuevas clases basadas en otras ya implementadas, lo que redunda en la reutilización de código. Además, si en el uso de la herencia nos basamos en clases cuyo código ya ha sido veriﬁcado y el cual se supone exento de errores, entonces será más fácil crear programas robustos, ya que únicamente deberemos preocuparnos por validar la nueva funcionalidad añadida en la subclase

Por supuesto sería posible crear objetos de tipo `Nave` en lugar de `NaveConEscudo`, pero en este caso tenemos que tener en cuenta que no se podría ejecutar el método `nave.activarEscudo()`. En el ejemplo mostrado, los objetos de la clase `NaveConEscudo` disparan y se dibujan exactamente igual a como lo hacen los objetos de la clase `Nave`, ya que estos métodos han sido heredados.

Podríamos pensar que a nuestra nueva nave no se le permita disparar cuando tiene activado el escudo, o que se dibuje de forma distinta a como lo hacía la nave básica. Ello implica que la clase `NaveConEscudo` no sólo introduce nuevas prestaciones respecto de la clase Nave, sino que además debe modiﬁcar parte del comportamiento ya establecido. 

Hay que mencionar que en Java no existe la herencia múltiple debido a los problemas que ello genera. Si se permitiera un esquema de herencia múltiple en el que la clase `C` hereda de la clase `A` y de la clase `B`, implicaría que la clase `C` heredaríaa tanto los métodos deﬁnidos en `A` como los deﬁnidos en `B`. Podría ocurrir que tanto `A` como `B` contuvieran un método con el mismo nombre y parámetros pero distinta implementación (distinto código), lo que provocaría un conﬂicto acerca de cuál de las dos implementaciones heredar.



### super

Una subclase puede referirse a la superclase inmediata mediante el uso de la palabra reservada `super`. Esta palabra reservada uele utilizarse para invocar al constructor de la superclase:
...
A diferencia de lo que ocurre con los métodos y atributos, los constructores no se heredan. 

Además de esta característica, deben tenerse en cuenta algunos aspectos sobre el comportamiento de los constructores dentro del contexto de la herencia, ya que dicho comportamiento es sensiblemente distinto al del resto de métodos.
...
La cuestión que se plantea es: ¿qué constructores se invocarán cuando se ejecuta la sentencia 
...
En el siguiente ejemplo se especiﬁca de forma explícita el constructor que deseamos ejecutar en A:
...
public class B extends A 
{
    ...
    public B(int j) {
        super(j);   // Ejecutar en la superclase un constructor que acepte un entero
        System.out.println("En B(j)");
    }
}
{% endhighlight %}
...
En resumen, cuando se crea un objeto de una clase, para determinar el constructor que debe ejecutarse en cada una de las superclases, en primer lugar se exploran los constructores en orden jerárquico ascendente (desde la subclase hacia las superclase). Con este proceso se decide el constructor que debe ejecutarse en cada una de las clases que componen la jerarquía. Si en algún constructor no aparece explícitamente una llamada a `super` se entiende que de forma implícita se está invocando a `super()` (constructor sin parámetros de la superclase). Finalmente, una vez se conoce el constructor que debe ejecutarse en cada una de las clases que componen la jerarquía, éstos se ejecutan en orden jerárquico descendente (desde la superclase hacia las subclases).
...
La sentencia `A obj = new A()` generaría un error de compilación, ya que en este caso no existe ningún constructor en `A` sin parámetros. Hemos perdido el constructor por defecto. Lo correcto sería, por ejemplo, `A obj = new A(5)`. Esta situación debe tenerse en cuenta igualmente cuando exista un esquema de herencia. Imaginemos la siguiente jerarquía de clases:
...
En este caso la sentencia `B obj = new B(5)` generará igualmente un error ya que, puesto que no hemos especiﬁcado un comportamiento distinto mediante `super()`, en `A` debería ejecutarse el constructor sin parámetros, sin embargo, tal constructor no existe puesto que se ha perdido el constructor por defecto. La solución pasaría por sobrecargar el constructor de `A` añadiendo un constructor sin parámetros,
...
1. En esta actividad vamos a trabajar sobre el código de la actividad 0127.

2. Crea una nueva rama en git y reescribe la aplicación usando herencia teniendo en cuenta los citerios indicados a continuación:

	1. En el muro de noticias solo se debe mostrar por cada post los datos correspondientes al nombre de usuario, el momento temporal en el que se grabó el post, el número de likes y los comentarios del post.

	2. El código (actualmente incompleto) de la clase `NewsFeed` debe ser el siguiente (si no eres capaz de imaginar cómo son las partes que faltan echa un vistazo en la pista):

			public class NewsFeed
			{
			    private ArrayList<Entrada> posts;
			     ...
			     */
			    public void addEntrada(Entrada post)
			    {
			        ...
			    }
	...
	3. El diagrama UML de la relación de herencia debe ser:

<img src="/images/Captura01.png" class="img-responsive">

<div markdown="0"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#0129_1">
Mostrar pista
</button></div>
<div id="0129_1" class="collapse" markdown="1">
El código final de la clase `NewsFeed` debe ser algo así:
...
1. En esta actividad trabajaremos a partir del código de la actividad 0129. 

2. Fija un punto de ruptura (breakpoint) en la primera línea del constructor de `EntradaTexto`. Crea un objeto `EntradaTexto`. Utiliza luego el botón "Step into" para comprobar paso a paso comos e inicializa el objeto. Fíjate en los atributos y cómo van tomando valores. 
...
2. Queremos añadir dos nuevos tipos de post a la red social:

	1. Entradas que incluyen además de un texto contengan un enlace (una dirección URL).

	2. Entradas que describen un evento de la red social. De momento solo vamos a conetmplar los siguientes eventos: alguien se hizo amigo de otro, alguien se unió a un determinado grupo o alguien cambio su foto de perfil.

3. Crea una nueva rama e implementa el primer tipo de post. Testeala y fusionala con la rama principal. 

4. Crea una nueva rama e implementa el segundo tipo de post. Se requiere que utilices una tipo enum para ello. Testeala y fusionala con la rama principal.



### Actividad 0132

1. En esta actividad trabajaremos a partir del código de la actividad 0131.

2. Nos hemos dado cuenta que ni en Facebook ni en Google+ los post relativos a eventos admiten likes ni permiten comentarios. Refactoriza el código para conseguir dicho objeto utilizando una nueva rama.



### Sobreescritura de métodos

Ya hemos visto que la herencia permite crear subclases que contienen todos los atributos y métodos de la clase superior. En las subclases se definen, además, atributos y métodos propios que no existían en la superclase. 

En ocasiones, interesa que la subclase modiﬁque alguno de los métodos heredados para que tenga un comportamiento distinto. Esto se realiza mediante la sobreescritura de metodos. Simplemente consiste en implementar en la subclase un método que ya existía en la superclase.
...
public class Planeta extends Esfera 
{
    ...
    public void mostrarValores() 
    {
        System.out.println("Radio = " + getRadio() + "  -  Num. Sat.= " + numSatelites);
    }
}
{% endhighlight %}

En este ejemplo la clase `Planeta` hereda el método `mostrarValores()` de `Esfera`, pero luego lo sobreescribe para poder mostrar tanto el radio como el número de satélites. 

En esta situación el método `mostrarValores` ejecutará un código distinto dependiendo del objeto sobre el que se invoque:
...
planeta.setRadio(6378);
planeta.setNumSatelites(3);

esfera.mostrarValores();     // Muestra los valores de la esfera
planeta.mostrarValores();     // Muestra los valores del planeta
{% endhighlight %}

El resultado de este programa sería:

	Radio = 10
	Radio = 6378  -  Num. Sat.= 3
...
public class Nave 
{
    ...
    public void moverDerecha(int dist) 
    {
    	posX++;
    }

    public void moverIzquierda(int dist) 
    {
    	posX--;
    }
...
public class NaveConEscudo extends Nave 
{
    private boolean escudo;

    public NaveConEscudo()
    {
        escudo = false;
    }
...
En este ejemplo podría ser interesante que `NaveConEscudo` modiﬁcase el comportamiento de alguno de los métodos heredados de `Nave`. Por ejemplo, podemos implementar que una nave con escudo no pueda disparar si tiene el escudo activado. Para ello, tal y como se ha visto, bastaría con sobreescribir el método correspondiente en la subclase:
...
public class NaveConEscudo extends Nave 
{
    ...
    public void disparar() 
    {
        if (!escudo && getMunicion() > 0) {
            //Aqui disminuiriamos la municion
        }
    }
}
{% endhighlight %}

De este modo cada nave tiene su propia versión del método `disparar`. 

De forma similar podría sobreescribirse el método `dibujar` para que cada tipo de nave tuviese una representación gráﬁca distinta.



### Sobreescritura de métodos: reemplazo y refinamiento

La sobreescritura de un método podemos enfocarla desde dos puntos de vista: reescribir el método completamente ignorando el código que hubiese en la superclase, o ampliar el código existente en la superclase con nuevas instrucciones. En el primer caso hablaremos de reemplazo y en el segundo de reﬁnamiento. 

Los ejemplos vistos anteriormente corresponden a una sobreescritura mediante reemplazo. Para implementar la sobreescritura mediante reﬁnamiento se debe invocar desde el método sobreescrito de la subclase el método correspondiente de la superclase mediante el uso de `super`. 

Por ejemplo podríamos pensar que una `NaveConEscudo` se dibuja como una `Nave` con algunos elementos extras. En este caso sería más interesante el reﬁnamiento que el reemplazo, ya que aprovecharíaamos el código del método `dibujar()` escrito para la clase `Nave`.

{% highlight java %}
public class Nave 
{
	//Omitidos otros atributos y métodos

    public void dibujar() 
    {
        // Codigo para dibujar una nave basica
    }
}
...
public class NaveConEscudo extends Nave 
{
    ...
    public void dibujar() 
    {
        ...
        // Aquí iría el codigo para dibujar los elementos extra
    }
}
{% endhighlight %}
...
### Herencia y métodos final

Aunque se ha visto que el modiﬁcador `final` se aplica a la declaración de aquellas variables que deseamos sean constantes, es decir, aquellas en las que el valor de la misma no debe cambiar tras su inicialización, cuando entra en juego la herencia, puede tener sentido además aplicar también el modiﬁcador `final` a la declaración de métodos. 

En este caso, un método declarado como `final` no puede ser sobreescrito en las subclases que hereden el método. Una declaración típica de un método `final` es así:
...
En este caso no podemos sobreescribir el método `showSample()` porque está marcado como `final`:

{% highlight java %}
public class SubClass extends SuperClass 
{
    public void showSample() { 
        //Se intenta sustituir el método final
...
Una ventaja de declarar un método como `final` es que el compilador colocará el código de bytes de este método, donde se invoque a dicho método, ya que se garantiza que no se puede modificar. Esto permite que la clase se ejecute con más eficacia. 

La biblioteca estándar de clases de Java declara como `final` muchos de los métodos que se utilizan con mayor frecuencia con la intención de obtener una mayor eficiencia durante la ejecución.



### Tipos de dato estático y dinámico. Conversion hacia arriba

Llegados a este punto conviene realizar una distinción importante entre lo que es la declaración de una variables y la creación del objeto al cual apuntará dicha variable.

En todos los ejemplos vistos hasta ahora se declaraban variable de un determinado tipo (una clase) y después se creaban un objeto de esa misma clase, al cual quedaba apuntando la variable.
...
En este caso vemos que el tipo (clase) de la variable coincide con el tipo de objeto que se crea. Sin embargo, esto no tiene por qué ser siempre así. De hecho es posible declarar una variable de una clase determinada y crear un objeto, no de dicha clase, sino de una subclase de la misma. 

Por ejemplo, dada la siguiente relación de clases:
...
{% highlight java %}
Esfera esfera = new Planeta();
{% endhighlight %}

Conviene diferenciar el tipo estático de una variable del tipo dinámico. Denominamos tipo estático al tipo con el que se declara una variable, y tipo dinámico al tipo del objeto al que apunta dicha variable. 

En el primer ejemplo mostrado, tanto el tipo estático como el tipo dinámico de la variable `esfera` es `Esfera`. Por el contrario, en el segundo ejemplo se ha declarado una variable `esfera` de tipo `Esfera` (tipo estático), pero el objeto creado es de tipo `Planeta` (tipo dinámico).

Como ha quedado reflejado, es posible declarar una variable de un tipo estático determinado y asignarle un objeto, no de dicha clase, sino de una subclase de la misma. Esto es, es posible que el tipo dinámico sea una subclase del tipo estático. 

Este modo de referenciar objetos en los que el tipo de una variable corresponde a una superclase del objeto almacenado es lo que denominamos conversión hacia arriba. 

El término hacia arriba viene motivado por la forma en que se representa gráﬁcamente la herencia, donde las superclases aparecen arriba de las subclases. En la conversión hacia arriba se almacena un objeto dado mediante una variable declaradad con un tipo o clase que jerárquicamente está “arriba” de la clase correspondiente al objeto creado.


### Limitaciones de la conversión hacia arriba

Cuando se utiliza la conversión hacia arriba es importante tener en cuenta una limitación: si creamos un objeto de un tipo determinado y empleamos una variable de una superclase para acceder al mismo, a través de dicha referencia únicamente podremos “ver” la parte del objeto que se deﬁnió en la superclase. Dicho de otro modo, el tipo estático limita la interfaz, esto es, la visibilidad que se tiene de los atributos y métodos de un objeto determinado. 
...
{% highlight java %}
B objeto1 = new B(); // Tipo estatico: A  Tipo dinámico: B
A objeto2 = new B(); // Tipo estatico: A  Tipo dinámico: B
B objeto3 = new A(); // Tipo estatico: B  Tipo dinámico: A. ¡ERROR!
{% endhighlight %}

En este caso, a partir de la variable `objeto1` se tiene acceso tanto al método `m1()` como a método `m2()`. Sin embargo, con la variable `objeto2`, a pesar de que almacena un objeto de tipo `B`, únicamente se tiene acceso a los métodos deﬁnidos en `A`, ya que el tipo estático impone esta limitación. La variable `objèto3` no es posible declararla de esa forma, ya que si se permitera, se debería tener acceso a elementos
que realmente no han sido creados (como el método `m2()`).

Retomando el ejemplo de la `Esfera` del apartado anterior, sobreescribamos ahora alguno de los métodos deﬁnidos en la superclase. Por ejemplo, supongamos que se desea medir la superﬁcie de un planeta con mayor precisión, teniendo en cuenta el achatamiento existente en los polos. Para ello podríamos redeﬁnir la clase `Planeta` como sigue:
...
{
    private int numSatelites;
    private double coeficienteAchatamiento;   
    
    public Planeta(double radio, double coeficienteAchatamiento) 
    {
        this.radio = radio;
        this.coeficienteAchatamiento = coeficienteAchatamiento;
    } 
    ...
    public double getSuperficie() 
    {
        // Calculos preciso de la superficie teniendo en cuenta
...
{% highlight java %}
Esfera esfera = new Planeta(6378, 35.3);
double superficie = esfera.getSuperficie();
{% endhighlight %}

El tipo estático `Esfera` contiene el método `getSuperficie`, por lo tanto dicho método es visible a través de la variable `esfera`; sin embargo es importante entender que se ejecutará el método del objeto que hemos creado (en este caso de tipo `Planeta`). Puesto que el método `getSuperficie` ha sido sobreescrito en la clase `Planeta` se ejecutará esta nueva versión del método.

A modo de resumen diremos que el tipo estático dictamina __qué__ operaciones pueden realizarse, pero es el tipo dinámico el que determina __cómo__ se realizan. Esta característica tiene una enorme transcendencia en la programación orientada a objetos ya que, como se verá mas adelante, permite realizar ciertas abstracciones sobre los tipos de datos (clases) con los que se trabaja.

Existen algunas restricciones lógicas en la utilización de tipos estáticos y dinámicos distintos. Una variable con un tipo estático determinado puede tener, como se ha visto, un tipo dinámico que sea derivado del tipo estático, pero no a la inversa. Esto es, la siguiente declaración no sería correcta:

{% highlight java %}
Planeta planeta = new Esfera();
{% endhighlight %}

La restricción impuesta es lógica por varios motivos. Si se declara una variable con el tipo estático `Esfera`, ésta puede ser utilizada para almacenar un objeto `Planeta`. Es como decir que “un planeta también es una esfera”. 

Sin embargo, no tiene tanto sentido declarar una variable de tipo `Planeta` e intentar referirse con ella a un objeto de tipo `Esfera`, ya que sería como decir que “cualquier esfera es un planeta”.

Desde el punto de vista semántico del lenguaje existe una razón todavía más contundente. Si declaramos una variable de tipo estático `Planeta` estamos indicando que con dicha variable podemos acceder a cualquier método de la clase `Planeta` (el tipo estático indica qué se puede hacer), esto es, deberíamos poder hacer:

{% highlight java %}
Planeta planeta = new Planeta();
planeta.setNumSatelites(1);
{% endhighlight %}

Sin embargo, si dicha variable la utilizamos para crear un objeto de tipo `Esfera`:
...
en dicho objeto no existirá el método `setNumSatelites`, por lo que la sentencia: 

{% highlight java %}
planeta.setNumSatelites(1);
{% endhighlight %}

resultaría incorrecta. De algún modo estaríamos dando al tipo estático un alcance o visibilidad mayor de lo que realmente existe en el tipo dinámico, lo que generaría inconsistencias como la que se acaba de exponer.



### Utilidad de la conversión hacia arriba

La conversión hacia arriba no es un capricho del lenguaje, sino que tiene una razón de ser. De hecho es una de las características fundamentales de la Programación Orientada a Objetos, ya que es la base de cuestiones tan importantes como el polimorfismo: en ocasiones resulta muy interesante poder llevar a cabo ciertas acciones sin necesidad de saber exactamente con qué tipo de objeto estamos trabajando. Con la conversión hacia arriba ignoramos el tipo real del objeto y lo tratamos de un modo más genérico. Ello permite realizar ciertas abstracciones sobre los objetos con los que trabajamos, yendo de lo concreto a lo general.

Tomemos el siguiente ejemplo: imaginemos que tenemos una serie de dispositivos (ﬁltros, ampliﬁcadores, conversores A/D, codiﬁcadores, etc.) los cuales pueden conectarse en serie para procesar una señal eléctrica. 

Supongamos que la cadena de proceso permite cualquier secuencia de este tipo de dispositivos. Todos los dispositivos tienen en común que poseen una salida a la cual puede conectarse cualquier otro dispositivo. 

Por otro lado, cada dispositivo tendrá ciertas características particulares que lo diferenciarán del resto. Podríamos pensar en una clase base o superclase denominada `Dispositivo` de la que heredasen las clases `Filtro`, `Amplificador`, `Conversor` o `Decodificador`.
...
public class Dispositivo 
{
    ...
    // Aqui irían el resto de atributos y metodos...
}
{% endhighlight %}

Lo interesante de este ejemplo es que el atributo `salida`, que es del tipo genérico `Dispositivo`, gracias a la conversión hacia arriba, puede utilizarse para almacenar objetos de cualquier tipo de dispositivo (ﬁltro, ampliﬁcador, etc.). De modo similar, el método `conectar()` admite cualquier tipo de dispositivo. Podría parecer extraño que un método que acepta como parámetro objetos de un tipo determinado pueda llegar a aceptar objetos de otro tipo, sin embargo, tomando el ejemplo anterior, hemos de pensar que al ﬁn y al cabo, un ﬁltro también es un tipo de dispositivo.



### Enlace dinámico. Polimorfismo

Con todo lo expuesto hasta ahora, ahora estamos en condiciones de entender el mecanismo que permite implementar el polimorﬁsmo en tiempo de ejecución: el enlace dinámico o selección dinámica de método. Tomemos como ejemplo la siguiente jerarquía de clases en la que se deﬁnen distintas ﬁguras geométricas:
...
public class Figura 
{
    public double area() 
    {
        return 0; // No sabemos que area tiene una figura generica
    }
}
...
for (int i = 0; i < 10; i++) {
    ...
    if (aleatorio > 0.5) {
        figuras[i] = new Rectangulo(10, 10);
    } else {
        figuras[i] = new Circulo(5);
    }
}

for (int i = 0; i < 10; i++) {
    double area = figuras[i].area(); // Seleccion dinamica de metodo
    System.out.println("Area = " + area);
}
{% endhighlight %}

En este programa se crea un array con 10 posiciones preparadas para almacenar objetos de tipo `Figura`, esto es, el tipo estático de cada elemento del array es `Figura` (hay que destacar que la sentencia `figuras = new Figura[10]` crea un array preperado para almacenar 10 objetos `Figura` pero aun no se ha creado ningún objeto `Figura`). 

A continuación se crean objetos de tipo `Rectangulo` y `Circulo` los cuales quedan almacenados en los elementos de `figura`. Por tanto, el tipo dinámico de cada elemento el array es o bien `Rectangulo` o bien `Circulo` (nótese el uso de la conversión hacia arriba explicada anteriormente).

Observemos que realmente no tenemos certeza sobre el tipo dinámico concreto ya que dicho tipo se ha elegido de forma  aleatoria, lo único que sabemos es que, de un modo más genérico, todos ellos son `Figuras`. 

Finalmente se calcula el área de cada ﬁgura mediante la sentencia `figuras[i].area()`. En esta situación se tiene que el tipo estático de `figuras[i]` es `Figura`, y puesto
que el método `area` está deﬁnido en dicho tipo, la sentencia `figura[i].area()` es correcta (el tipo estático indica __qué__ podemos hacer). 

Sin embargo, ya se ha explicado que realmente se ejecutará el método `area()` deﬁnido en el tipo dinámico (el tipo dinámico indica __cómo__ se hace). Se ejecutará por tanto el método `area()` del objeto que se haya creado en cada caso.

Llegados a este punto no es difícil observar que es imposible conocer en tiempo de compilación cuál de los métodos `area()` se va a ejecutar en cada caso, ya que hasta que no se ejecute el programa no se van a conocer los tipos dinámicos de cada ﬁgura. En consecuencia debe existir un mecanismo que en tiempo de ejecución, y no en tiempo de compilación, sea capaz de establecer qué método ejecutar en función del tipo dinámico del objeto. Dicho mecanismo existe en la máquina virtual de Java y se conoce como enlace dinámico o selección dinámica de método y es el elemento clave que permite llevar a cabo el polimorﬁsmo en tiempo de ejecución.

El polimorﬁsmo es una característica fundamental de los lenguajes orientados a objetos, que permite realizar ciertas abstracciones sobre los tipos de datos. 

Lo sorprendente del ejemplo anterior es que el programa principal no necesita saber qué tipo de objetos hay almacenados en el array para poder realizar ciertas operaciones con ellos (calcular el área en este caso); es suﬁciente con saber que, de forma genérica, son ﬁguras. 

Es más, sería posible crear nuevos tipos de ﬁguras, por ejemplo triángulos, y añadirlas en el array; el bucle que calcula el área de cada una de ellas seguiría funcionando sin necesidad de ningún cambio, a pesar de que cuando se escribió ni siquiera existía la clase `Triangulo`. 

Esto es así porque realmente a la hora de escribir el bucle que calcula las áreas no estamos concretando el método `area` que deseamos ejecutar, sino que lo estamos posponiendo hasta el último momento (la ejecución del programa) lo que permite en cualquier momento crear nuevas ﬁguras, cada una con su propio método `area()`.

Supongamos ahora que necesitamos un método que calcule si dos ﬁguras cualesquiera tienen o no la misma área. Para ello podríamos añadir a la clase `Figura` el método `mismaArea()`:
...
Ahora la clase `Figura` implementa dos métodos, uno de los cuales (`area()`) se sobreescribe en las subclases y otro (`mismaArea()`) que se hereda tal cual. Observemos ahora el siguiente fragmento de código:
...
if (f1.mismaArea(f2))
	System.out.println("Figuras con la misma area");
{% endhighlight %}

El método `mismaArea()` deﬁnido en la clase `Figura` invoca a su vez al método `area()`, pero ¿qué método `area()` se ejecuta en este caso? Tratemos de averiguar qué método `area()` se ejecuta en la llamada `double a1 = area()`. 

Un razonamiento erróneo podría llevar a pensar que, puesto que estamos ejecutando el método `mismaArea()` que se encuentra en la clase `Figura` (ya que no ha sido sobreescrito en `Rectangulo` ni en `Circulo`) entonces cuando este mismo método invoca a su vez a `area()` se estará ejecutando igualmente el método area deﬁnido en `Figura`.

El error de este razonamiento radica en pensar que se está ejecutando el método `mismaArea()` de la clase `Figura`. Realmente dicho método se está ejecutando sobre un objeto de tipo `Rectangulo` ya que el tipo dinámico de `f1` corresponde a esta clase y, si bien es cierto que `Rectangulo` no sobreescribe el método `mismaArea()`, sí que lo hereda. En otras palabras, `Rectangulo` tiene su propio método `mismaArea()`, cuyo código es idéntico al método `mismaArea()` deﬁnido en `Figura`. 

Una vez aclarado que se ejecuta el método `mismaArea()` de Rectangulo, parece lógico pensar que la llamada al método `area()` se ejecutará también sobre la clase Rectangulo. Ello podría verse más claro si en lugar de escribir:
...
Sabemos que `this` siempre hace referencia al objeto que invocó al método. Puesto que en nuestro ejemplo el método `mismaArea()` fue invocado por `f1`, mentalmente podemos substituir `this.area()` por `f1.area()`, donde es obvio que `f1` referencia a un objeto de tipo `Rectangulo`. 

Por otro lado, en la llamada `double a2 = otra.area();` la variable `otra` toma su valor de `f2`, la cual a su vez referencia a un objeto de tipo `Circulo`. En este caso, por tanto, se ejecutará el método `area` de la clase `Circulo`.

Nuevamente, lo sorprendente del método `mismaArea()` es que puede comparar las áreas de cualquier tipo de ﬁgura, aunque todavía no hayan sido deﬁnidas. Si en un futuro deﬁnimos la clase `Trianngulo` o `Dodecaedro` el método `mismaArea()` podrá trabajar con este tipo de objetos sin necesidad de cambiar una sola línea de su código. Esto es así porque el método `area()` es un método polimórﬁco (cambia de forma, o de código, en función del contexto en el que se ejecuta). El único requerimiento será que `Dodecaedro` herede de `Figura` y que sobreescriba su propia implementación del método `area()`.
