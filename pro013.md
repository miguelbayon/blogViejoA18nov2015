...
11. Codifica un método en la clase `DrawDemo` llamado `drawSpiral` que dibuje una espiral como la que se muestra a continuación.
	...
	<img src="/assets/images/spiral.png" class="img-responsive">
...
La herencia es uno de los principios básicos de la programación orientada a objetos. 

En nuestro caso nos permite que en vez de definir dos clases completamente independientes como actualmente son `MessagePost` y `PhotoPost` 